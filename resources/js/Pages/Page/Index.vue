                ...
                <div>
                    <form>
                        ...
                        <div class="relative">
                            ...
                            <form @submit.prevent="searchIt" class="px-0.5">
                                <input
                                    autofocus
                                    autocomplete="off"
                                    v-model="form.search"
                                    ...
                                    id="default-search"
                                    class="
                                    block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Posts..." required>
                                <div class="absolute end-2.5 bottom-2.5  flex justify-end gap-2 items-center">
                                    ...
                                    <Link :href="route('pages.index')"
                                          class="
                                          sm:block hidden
                                          text-gray-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Reset</Link>
                                </div>
                            </form>
                        </div>
                    </form>
                ...
                <div v-for="(page, index) in pages.data" :key="page.id" v-else>
                    <section class="">
                        <div class="gap-8 py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-12 sm:py-16 lg:px-6">
                            <div class="w-full h-[300px] col-span-4  mt-4 sm:mt-0" v-if="index % 2 === 0">
                            ...
                            <div class="mt-4 md:mt-0 mx-auto h-full w-full relative  col-span-8">
                                <div class="flex justify-between mx-auto items-center mb-4 ">
                                    <h2 class="text-2xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                                        <Link :href="page.url" class="underline">
                                            {{ page.title }}
                                        </Link>
                                        <a
                                            :href="`/admin/pages/${page.id}/edit`"
                                            target="_blank"
                                            class="underline text-xs ml-4" href="" v-if="$page.props.auth?.id">edit</a>
                                    </h2>
